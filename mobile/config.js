...
export const MAX_LENGTH_PSEUDO = 30;
export const MAX_LENGTH_LASTNAME = 30;
export const MAX_LENGTH_FIRSTNAME = 30;
...
export const MAX_LENGTH_COMMENT = 250;

export const REVIEW_ADD_SUCCESS = "The review has been successfully created!";
export const REVIEW_MODIFY_SUCCESS = "Your review has been successfully modify";

// REPORT

export const MAX_LENGTH_REASON = 250;
